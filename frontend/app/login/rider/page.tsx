                ...
                <form action={handleSubmit} className="space-y-4 flex-1">
                    ...
                    {mode === 'signup' && (
                        <div>
                            ...
                            <input name="name" required placeholder="e.g. Arjun Mehta" className="uni-input" />
                        </div>
                    )}
                    <div>
                        <label className="block text-xs font-semibold mb-1.5 text-primary">Email (University Domain)</label>
                        <input name="email" required placeholder="e.g. arjun@university.edu" className="uni-input" />
                    </div>
                    {mode === 'signup' && (
                        <div>
